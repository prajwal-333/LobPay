...
create_inventory_merchant_table = """CREATE TABLE IF NOT EXISTS Merchants_Inventory(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, mid INTEGER NOT NULL, quantity INTEGER NOT NULL, item_id INTEGER NOT NULL,FOREIGN KEY(mid) REFERENCES Merchants(id) ON DELETE CASCADE,FOREIGN KEY(item_id) REFERENCES Inventory(id) ON DELETE CASCADE)"""
