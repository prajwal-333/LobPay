...
create_merchant_table = """CREATE TABLE IF NOT EXISTS Merchants(id INTEGER PRIMARY KEY NOT NULL, address text, account_info text,pincode INTEGER, FOREIGN KEY(id) REFERENCES Users(id) ON DELETE CASCADE);"""
