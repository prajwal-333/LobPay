...
create_customer_table = """CREATE TABLE IF NOT EXISTS Customers(id INTEGER PRIMARY KEY NOT NULL,pin INTEGER, FOREIGN KEY(id) REFERENCES Users(id) ON DELETE CASCADE);"""
create_merchant_table = """CREATE TABLE IF NOT EXISTS Merchants(id INTEGER PRIMARY KEY NOT NULL, address text, account_info text,pin INTEGER, FOREIGN KEY(id) REFERENCES Users(id) ON DELETE CASCADE);"""
